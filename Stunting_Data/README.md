...
| `BD2` | L'enfant a déjà été allaité |
...
| `HAZ2`, `WAZ2`, `WHZ2` | Indices anthropométriques standardisés (référence OMS 2006) |
...
ch, meta_ch = pd.read_spss("ch.sav", convert_categoricals=False), None
